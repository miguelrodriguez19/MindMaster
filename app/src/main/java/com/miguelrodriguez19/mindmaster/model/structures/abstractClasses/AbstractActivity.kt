...
abstract class AbstractActivity : java.io.Serializable {
    ...
    fun createNotification(context: Context) {
        NotificationUtils.createScheduleNotification(context, this)
    }


    abstract fun getActivityRepetition(): Repetition

    companion object {
        fun fromJSON(json:String) : AbstractActivity {
            return Gson().fromJson(json, AbstractActivity::class.java)
        }
